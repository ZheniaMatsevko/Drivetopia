...
public class NewTheoryScreen extends ScreenAdapter implements InputProcessor {
    Drivetopia app;
    ...
    public NewTheoryScreen(final Drivetopia app, String title, int userID, int chosenLevel) {
